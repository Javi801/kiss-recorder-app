...
export default function MainScreen({
  ...
  const totalEvents = people.reduce((sum, person) => sum + (person.events?.length || 0), 0)
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        ...
        <CardContent style={{ position: 'relative', padding: '1.5rem' }}>
          ...
          >
            ...
            >
              ...
              >
                <Languages
                  style={{ height: '1.25rem', width: '1.25rem', color: PALETTE.textOnAccent }}
                />
              </Button>
            ...
            >
              ...
              >
                {statsVisible ? (
                  ...
                  <EyeOff
                    style={{ height: '1.25rem', width: '1.25rem', color: 'rgba(255,255,255,0.55)' }}
                  />
                )}
              </Button>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            >
              ...
              >
                <Languages
                  style={{ height: '1.5rem', width: '1.5rem', color: PALETTE.textOnAccent }}
                />
              </div>
              ...
              return (
                <Button
                  ...
                  style={{
                    ...
                    boxShadow: selected ? `0 2px 8px ${PALETTE.accentShadow}` : 'none',
                  }}
                  onClick={() => {
      ...
      <Dialog
        ...
        onOpenChange={(open) => {
          if (!open) setJsonExportStatus(null)
        }}
      >
        <DialogContent
          ...
          <DialogHeader>
            <div
              style={{
                ...
                alignItems: 'center',
                gap: '0.5rem',
                color: jsonExportStatus?.hadMissingFields
                  ? PALETTE.warningBadgeText
                  : PALETTE.accent,
              }}
            >
        ...
        >
          ...
          <DialogFooter>
            ...
            <Button
              className="rounded-xl"
              style={{
                background: PALETTE.accentEmphasis,
                color: PALETTE.textOnAccent,
                border: 'none',
              }}
              onClick={() => {
        ...
        >
          <DialogHeader>
            <div
              style={{
                ...
                alignItems: 'center',
                gap: '0.5rem',
                color: PALETTE.accentEmphasis2,
              }}
            >
              <Upload style={{ height: '1.25rem', width: '1.25rem', flexShrink: 0 }} />
              <DialogTitle style={{ color: PALETTE.accentEmphasis2 }}>
                {t.importJsonConfirmTitle}
              </DialogTitle>
            </div>
            <DialogDescription asChild>
              <div
          ...
          <DialogFooter>
            ...
            <Button
              className="rounded-xl"
              style={{
                background: `linear-gradient(90deg, ${PALETTE.accentEmphasis2}, ${PALETTE.emphasisEnd})`,
                color: PALETTE.textOnAccent,
                border: 'none',
              }}
              onClick={() => {
      ...
      >
        ...
        >
          <DialogHeader>
            ...
            >
              <CheckCircle2 style={{ height: '1.25rem', width: '1.25rem', flexShrink: 0 }} />
              <DialogTitle style={{ color: PALETTE.accent }}>
                {t.importJsonSuccessTitle}
              </DialogTitle>
            </div>
            <DialogDescription asChild>
        ...
        >
          <DialogHeader>
            ...
            >
              <TriangleAlert style={{ height: '1.25rem', width: '1.25rem', flexShrink: 0 }} />
              <DialogTitle style={{ color: PALETTE.accentEmphasis }}>
                {importStatus?.type === 'error_type'
                  ? t.importJsonErrorTypeTitle
                  : t.importJsonErrorFormatTitle}
              </DialogTitle>
            </div>
            <DialogDescription style={{ color: PALETTE.textSoft }}>
              {importStatus?.type === 'error_type'
                ? t.importJsonErrorTypeDesc
                : t.importJsonErrorFormatDesc}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
