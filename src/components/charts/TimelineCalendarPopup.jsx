...
export default function TimelineCalendarPopup({ gran, offset, onOffsetChange, locale, title }) {
  ...
  let calTitleLabel
  if (calView === 'days')
    calTitleLabel = capitalize(fmtMonthYear.format(new Date(viewYear, viewMonth - 1, 1)))
      ...
      >
        ...
        >
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (canCycleTitle) e.currentTarget.style.backgroundColor = P.accentMuted
            }}
            onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = 'transparent')}
          >
            {calTitleLabel}
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (!isNextDisabled) e.currentTarget.style.backgroundColor = P.accentMuted
            }}
            onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = 'transparent')}
          >
              ...
              {cells.map((day, i) => {
                ...
                return (
                  <button
                    ...
                    disabled={isDisabled}
                    style={{
                      ...gridItemStyle({ isSelected, isToday, isDisabled }),
                      aspectRatio: '1',
                      borderRadius: '50%',
                    }}
                    onMouseEnter={(e) => {
                      if (!isSelected && !isDisabled)
                        e.currentTarget.style.backgroundColor = P.accentMuted
                    }}
                    onMouseLeave={(e) => {
                      if (!isSelected && !isDisabled)
