  ...
  return (
    <TileCard>
      <>
        ...
        <p style={{ ...TEXT.label, textTransform: "uppercase", letterSpacing: "0.12em", color: colors.label }}>
          {label}
        </p>

        {isMultiple && (
          <p style={{ marginTop: "0.125rem", fontSize: "0.7rem", lineHeight: "1rem", color: colors.helper }}>
            {topPeople.length} {t.tiedForTop}
          </p>
        )}

        {isEmpty ? (
          <p style={{ marginTop: "0.5rem", fontSize: "1.875rem", lineHeight: "2.25rem", fontWeight: "700", letterSpacing: "-0.025em", color: colors.value }}>
            —
          </p>
        ) : (
          <div
          ...
          >
            {topPeople.map((person, idx) => (
              ...
              >
                <p style={{ fontSize: "1.875rem", lineHeight: "2.25rem", fontWeight: "700", letterSpacing: "-0.025em", color: colors.value }}>
                  {person.value}
                </p>
